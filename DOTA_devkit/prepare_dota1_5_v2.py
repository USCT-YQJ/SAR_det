...
def parse_args():
    ...
    parser.add_argument('--srcpath', default='/ssd/wqj/project/SAR/ReDet-master/data/dota15')
    parser.add_argument('--dstpath', default='/ssd/wqj/project/SAR/ReDet-master/data/final_coco_ms',
                        help='prepare data')
...
def prepare(srcpath, dstpath):
    ...
    split_test = SplitOnlyImage_multi_process.splitbase(os.path.join(srcpath, 'final_test'),
    ...
    split_test_ms = SplitOnlyImage_multi_process.splitbase(os.path.join(srcpath, 'final_test'),
