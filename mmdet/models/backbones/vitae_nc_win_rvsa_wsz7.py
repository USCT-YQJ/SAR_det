...
class RotatedVariedSizeWindowAttention(nn.Module):
    def __init__(self, dim, num_heads, out_dim=None, window_size=1, qkv_bias=True, qk_scale=None, 
        ...
        super(RotatedVariedSizeWindowAttention,self).__init__()
...
#            self.shift_size = 0
    ...
    def forward(self, x, H, W):
        ...
        base_coords_h = base_coords_h.float()
        ...
        base_coords_w = base_coords_w.float()
...
class NormalCell(nn.Module):
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
                drop_path=0., act_layer=GELU, norm_layer=nn.LayerNorm, class_token=False, group=1, 
...
class ViTAE_NC_Win_RVSA_V3_WSZ7(BaseBackbone):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=80, embed_dim=768, depth=12,
        ...
        super(ViTAE_NC_Win_RVSA_V3_WSZ7,self).__init__()
...
#        self.head = nn.Linear(embed_dim, num_classes) if num_classes > 0 else nn.Identity()
    ...
    #     super(ViTAE_NC_Win_RVSA_V3_WSZ7, self).init_weights(pretrained)
