...
def parse_args():
    ...
    parser.add_argument('--dstpath', default='/ssd/wqj/project/SAR/ReDet-master/data/coco_debug',
                        help='prepare data')
...
def prepare(srcpath, dstpath):
    ...
    split_test = SplitOnlyImage_multi_process.splitbase(os.path.join(srcpath, 'test_debug', 'images'),
