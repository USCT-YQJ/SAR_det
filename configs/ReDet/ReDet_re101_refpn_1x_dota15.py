...
model = dict(
    type='ReDet',
    pretrained='/ssd/wqj/project/SAR/ReDet-master/work_dirs/ReResNet_pretrain/re_resnet101_v2_c8_batch256-f248cc41.pth',
    backbone=dict(
        type='ReResNet',
        depth=101,
        num_stages=4,
...
log_level = 'INFO'
work_dir = 'work_dirs/ReDet_re101_refpn_1x_dota15'
load_from = None
resume_from = None
workflow = [('train', 1)]